...
namespace MilkTea
{
    public partial class MainAddEmployee : Form
    {
        public MainAddEmployee()
        {
            InitializeComponent();
        }
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            if (IsValid())
            {
                try
                {
                    ...
                    {
                        var newEmployee = new Account
                        {
                            Username = txtUsername.Text,
                            Password = txtPassword.Text,
                            RoleId = 3,// employee roleid = 3
                        ...
                        db.Accounts.Add(newEmployee);
                        db.SaveChanges();

                        MessageBox.Show("New employee is added success.");
